...
class PolicyDecision(BaseModel):
    ...
    aggressiveness: int = Field(..., ge=0, le=100, description="Percentual de agressividade aplicado à política decisória.")
    decision_explanation: str = Field(..., description="Fundamentação estatística e formal da recomendação.")
