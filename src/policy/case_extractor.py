...
def parse_case_folder(folder_path: str) -> dict:
    ...
    has_bacen = int(any("bacen" in f or "comprovante" in f for f in filenames_lower))
    ...
    has_evolucao = int(any("demonstrativo" in f or "evolucao" in f for f in filenames_lower))
    ...
    termos_golpe = ['clonagem', 'estelionato', 'falso', 'fraude', 'golpe', 'terceiro']
    ...
    row = {
        ...
        'qtd_subsidios': sum([has_bacen, has_contrato, has_dossie, has_evolucao, has_extrato, has_laudo])
    }
